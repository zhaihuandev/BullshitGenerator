...
public class TxtUtils {
    //描述
    public static String[] expound = new String[]{"现在，解决主题的问题，是非常非常重要的。 所以， ",
    ...
    //名言
    public static String[] sayings = new String[]{"伏尔泰曾经说过，不经巨大的困难，不会有伟大的事业。这不禁令我深思",
    ...
    public static String[] after = new String[]{
            "这不禁令我深思. ",
